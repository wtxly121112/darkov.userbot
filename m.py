...
#сасно да? как и хуй даркова
	HELP =  '''-/ХУЙ ДАРКОВА??/-/n| .help - услуги даркова?)?)))?)?)/n| .пасты [NUMBER] - отправить [NUMBER] паст, по умолчанию 1/n| .new [TEXT] - добавить новую пасту/n| .ghoul - вычитаем с тысячи семь вплоть до -1/n| .spam [NUMBER] [TEXT] - ну кто не понял, тому скину деньги на лечение/n| .нсп[NUMBER (1-3)] - максимальное количество нсп на данный момент [3]/n| .соси - типикал хуйня от даркова/n| .type - передвижение спермы даркова по тексту'''
